...
from src.model.utils import inverse_sigmoid
from src.model.ms_deform_attn import MSDeformAttn
...
class DeformableTransformer(nn.Module):
    ...
    def forward(self, srcs, pos_embeds, query_embed, text_embed, text_pos_embed, text_mask=None):
...
class DeformableTransformerEncoder(nn.Module):
    ...
    def get_reference_points(spatial_shapes, valid_ratios, device):
        ...
        for lvl, (H_, W_) in enumerate(spatial_shapes):
            ...
            ref = torch.stack((ref_x, ref_y), -1)  # TODO: check what is ref_pts
